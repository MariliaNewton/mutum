...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>Sobre a Mutum | Fotografia com afeto</title>
        <meta
          name="description"
          content="Somos Ana e Mari, psicólogas e fotógrafas que contam histórias reais por meio da fotografia. Atuamos em Maceió, Milagres e todo o litoral de Alagoas."
        />
      </Helmet>
      <section className="about-section">
        ...
        <div className="about-container">
          ...
          >
            ...
            <div>
              ...
              <motion.p
                ...
                transition={transitionText}
              >
                <span>Mariana</span> Bezerra Marroquim é fotógrafa apaixonada
                por contar histórias através de imagens. Com formação que inclui
                referências literárias e artísticas, ela traduz emoções e
                narrativas pessoais em cada clique, explorando a profundidade
                dos sentimentos humanos e a beleza dos momentos cotidianos.
              </motion.p>
            </div>
          </motion.div>
          <motion.img
          ...
          >
            Assim nasceu a Mutum Fotografias, unindo a sensibilidade única de
            Ana, que com sua experiência e olhar acolhedor captura as emoções
            mais profundas e genuínas de cada pessoa, e a criatividade de
            Mariana, que traduz histórias e sentimentos em imagens autênticas e
            poéticas. Juntas, elas criam uma fotografia que vai além do momento,
            buscando eternizar as memórias de maneira intimista, verdadeira e
            especial. A Mutum Fotografias é o encontro de duas visões
            complementares, proporcionando uma experiência única, onde cada
            clique conta uma história pessoal e emocional, conectando as pessoas
